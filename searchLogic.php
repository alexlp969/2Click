...
<div id="tabs-3" class="panel panel-primary">
   ...
   <div id="tabs-4" class="panel panel-primary">
			<form action="../search/invoice.php" method="POST">
			 <div class="panel-heading">Invoice</div>
			  ...
			  <div class="row">
			    ...
			    <div class="row">
				    ...
				    <div class="col-sm-3">
				    	<input type="text" class="form-control" id="inDate" name="inDate" readonly="readonly" value="'.$dateIn[0].'">
				    </div>
			    </div>
				  <div class="row"><br></div>
					<div class="row">
   		...
   		<label class="col-sm-1">Postcode:</label>
			...
			<div class="row"><br></div>
			  <div class="row">
				    		<label class="col-sm-1">Charger:</label>
			    	<div class="col-sm-3">
			    		<input type="text" class="form-control" id="charger" name="charger" placeholder="Charger" readonly="readonly" value="'.$charger.'">
			    	</div>
			    	<label class="col-sm-1">Case:</label>
			    	<div class="col-sm-3">
			    		<input type="text" class="form-control" id="case" name="case" placeholder="Case" readonly="readonly" value="'.$case.'">
			    	</div>
			    	 <label class="col-sm-1">CD:</label>
			    	<div class="col-sm-3">
			    		<input type="text" class="form-control" id="cd" name="cd" placeholder="CD" readonly="readonly" value="'.$cd.'">
			    	</div>
			    </div>
			     <div class="row"><br></div>
			    <div class="row">
			    <label class="col-sm-1">Cable:</label>
				    <div class="col-sm-3">
				    	<input type="text" class="form-control" id="Cable" name="Cable" placeholder="Cable" readonly="readonly" value="'.$cable.'">
				    </div>
			    	<label class="col-sm-1">Manual:</label>
			    	<div class="col-sm-3">
			    		<input type="text" class="form-control" id="Manual" name="Manual" placeholder="Manual" readonly="readonly" value="'.$manual.'">
			    	</div>
			    	<label class="col-sm-1">Additional:</label>
			    	<div class="col-sm-3">
			    		<input type="text" class="form-control" id="Additional" name="Additional" placeholder="Additional" readonly="readonly" value="'.$additional.'">
			    	</div>
				</div>
							<div class="row"><br></div>
			  <div class="row">
			    ...
			    <div class="row">
			    			...
			    			5: All successfull repairs have 90 days warranty. <br>
			    			  ...
			    			  <button class="btn btn-primary" type="button" id="edit" onclick="edit();" > Edit </button>
			 
			    			  <button class="btn" type="button" id="cancel" href="search.php" onclick='."window.location='index.php'".'>Cancel</button>
		...
		{
			$menuSQL = "SELECT * FROM `customer` ORDER BY `customer`.`id` ASC ";
		...
		echo'<form  action="index.php" method="POST"> 
				  <div class="panel panel-primary">
					 ...
					 <div class="panel-heading"><h3>Search for a customer</h3></div>
					  <div class="panel-body">
					  	<div class="row">
						    <div class="col-sm-5">
			...
			<?php     echo' <input type="hidden" class="action" name="action" value="search">
							</div>
